...
<HTML>
	...
	<body>
		...
		<s:form action="buser_add" namespace="/" theme="simple" onsubmit="return CheckbuserForm();">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield name="buserPasswd" id="buserPassword" onblur="CheckNullAndLengthAndCharacter('buserPassword','密码','buserPasswordError')"/>
