...
public class ProductAction extends ActionSupport implements ModelDriven<ProductInfo>{
	...
	private ProductDescriptionPageService ppService = new ProductDescriptionPageService();
	...
	*/
	...
	public String edit() throws Exception{
		...
		*/
		...
		Integer businessId = ppService.getProduct(model.getProductId()).getBusinessId();
